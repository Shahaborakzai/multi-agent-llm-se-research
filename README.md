...
After the initial defense, experiments were significantly expanded to 773 total runs across two standard benchmarks.

### Extended Configurations Tested

| Configuration | Description |
|---|---|
| Baseline (No Roles) | Direct task prompt with no role assignment |
| Coder Only | Single Coder agent with format constraint |
| Coder + Tester | Two-role pair programming system |
| Manager + Coder + Tester | Full three-role system |

### HumanEval Results (164 tasks, metric: pass@1)

| Configuration | Tasks | Pass | Fail | pass@1 |
|---|---|---|---|---|
| Baseline (No Roles) | 161 | 149 | 12 | 92.5% |
| Coder Only | 164 | 155 | 9 | 94.5% |
| Coder + Tester | 164 | 152 | 12 | 92.7% |
| **Manager+Coder+Tester** | **164** | **156** | **8** | **95.1%** |

### SWE-bench Lite Results (30 tasks, metric: resolve_rate)

| Configuration | Resolved | Failed | Rate | Avg Time |
|---|---|---|---|---|
| Baseline (No Roles) | 22 | 8 | 73.3% | 296s |
| **Coder Only** | **25** | **5** | **83.3%** | **232s** |
| Coder + Tester | 20 | 10 | 66.7% | 331s |
| Manager+Coder+Tester | 24 | 6 | 80.0% | 295s |

### Q1 — Prompt Ablation Study (140 runs, 7 variants)

**Finding:** Output format constraint is the single critical component. Without it: 0% pass rate regardless of role identity.

| Variant | pass@1 |
|---|---|
| Coder A — Identity only | 0.0% |
| Coder B — Identity + Responsibility | 0.0% |
| **Coder C — Full prompt with format** | **100.0%** |

### Q2 — State Prediction Method

Decision Tree classifier predicts optimal role with **86% cross-validation accuracy**.

**Top features:** type_count (0.267), num_words (0.217), examples (0.159)

| Method | pass@1 | Type |
|---|---|---|
| Best fixed config | 95.1% | Fixed |
